...
class Permission{
    ...
    /**
     * @description This method provides all module permission.
     * @param int $role_id
     * @param string $module_name
     * @return mixed
     */
