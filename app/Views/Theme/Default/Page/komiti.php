    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main_content position-relative">
                ...
                <center><p class="main-title"> প্রতিষ্ঠান পরিচালনা কমিটি  </p></center>
                ...
                <div class="main-text">
                    <table class="table table-bordered " id="teacher">
                        ...
                        <tr>
                            <td>১. </td>
                            <td> মোঃ নাজির হোসেন  </td>
                            <td> সভাপতি  </td>
                        </tr>
                        <tr>
                            <td>২. </td>
                            <td> মোঃ আজিজুর রহমান   </td>
                            <td> সহ—সভাপতি  </td>
                        </tr>
                        <tr>
                            <td>৩. </td>
                            <td> মোঃ দেলোয়ার হোসেন  </td>
                            <td> অধ্যক্ষ/সদস্য সচিব </td>
                        </tr>
                        <tr>
                            <td>৪. </td>
                            <td> মোঃ আনিচুর রহমান  </td>
                            <td> সদস্য </td>
                        </tr>
                        <tr>
                            <td>৫. </td>
