...
/**
 * @description This function provides all notice.
 * @param string $table
 * @return array
 */
function get_all_notice()
{
    $tableSel = DB()->table('cc_notice');
    $query = $tableSel->where('status','1')->orderBy('notice_id','ASC')->get()->getResult();
    return $query;
}

/**
 * @description This function provides all notice view in marquee.
 * @return array
 */
function notice_marquee_view()
{
    $tableSel = DB()->table('cc_notice');
    $query = $tableSel->where('status','1')->orderBy('notice_id','ASC')->limit(3)->get()->getResult();
    return $query;
}